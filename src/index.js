...
class Scene {
    ...
    addTextures() {
        ...
        this.galaxyTexture = textureLoader.load("/assets/textures/galaxy.png");
        ...
        this.groundTexture = textureLoader.load("/assets/textures/marskorrels.jpg");
        ...
        this.houseBaseTexture = textureLoader.load("/assets/textures/metal.jpg");
        ...
        this.houseLevelTexture = textureLoader.load("/assets/textures/metal.jpg");
        ...
        this.houseLevel2Texture = textureLoader.load("/assets/textures/metal.jpg");
        ...
        this.houseRoofTexture = textureLoader.load("/assets/textures/gold-foil.webp");
        ...
        this.windowTexture = textureLoader.load("/assets/textures/window.jpg");
        ...
        this.doorTexture = textureLoader.load("/assets/textures/door.jpg");
    ...
    addText() {
        ...
        textLoader.load(
            '/assets/fonts/TheWildBreathofZelda_Regular.json',
            (droidFont) => {
